            ...
            <div class="panel-group" id="accordion">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="javascript:$('#content').load('${pageContext.request.contextPath}/back/user.jsp');" class="list-group-item">用户信息管理</a></li>
                                <li><a href="javascript:$('#content').load('${pageContext.request.contextPath}/back/xushi.jsp');" class="list-group-item">用户注册趋势</a></li>
                                <li><a href="javascript:$('#content').load('${pageContext.request.contextPath}/back/ditu.jsp');" class="list-group-item">用户注册分布</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="panel panel-success">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="javascript:$('#content').load('${pageContext.request.contextPath}/back/lunbo.jsp');" class="list-group-item">轮播图信息</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="panel panel-info">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="javascript:$('#content').load('${pageContext.request.contextPath}/back/shangshi.jsp');" class="list-group-item">上师信息</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="panel panel-warning">
                    ...
                    <div id="collapseFour" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="javascript:$('#content').load('${pageContext.request.contextPath}/back/wenzhang.jsp');" class="list-group-item">文章信息</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="panel panel-warning">
                    ...
                    <div id="collapseFive" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li><<a href="javascript:$('#content').load('${pageContext.request.contextPath}/back/album.jsp');" class="list-group-item">专辑信息</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
